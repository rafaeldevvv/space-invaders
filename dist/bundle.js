...
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.wigglyBulletPieces = exports.playerPieces = exports.bossPieces = exports.aliensPieces = exports.colors = exports.GAME_DISPLAY = exports.GAMEOVER_SCREEN_LAYOUT = exports.INITIAL_SCREEN_LAYOUT = void 0;\nconst aliens_1 = __webpack_require__(/*! @/plans/aliens */ \"./src/plans/aliens.ts\");\nconst boss_1 = __importDefault(__webpack_require__(/*! @/plans/boss */ \"./src/plans/boss.ts\"));\nconst IterablePieces_1 = __importDefault(__webpack_require__(/*! @/utils/common/IterablePieces */ \"./src/utils/common/IterablePieces.ts\"));\nconst player_1 = __importDefault(__webpack_require__(/*! @/plans/player */ \"./src/plans/player.ts\"));\nconst wiggly_bullet_1 = __importDefault(__webpack_require__(/*! @/plans/wiggly-bullet */ \"./src/plans/wiggly-bullet.ts\"));\nexports.INITIAL_SCREEN_LAYOUT = {\n    titleYPos: 30,\n    pressMessageYPos: 80,\n};\nexports.GAMEOVER_SCREEN_LAYOUT = {\n    titleYPos: 16,\n    pressMessageYPos: 80,\n};\nexports.GAME_DISPLAY = {\n    maxWidth: 920,\n    aspectRatio: 4 / 3,\n};\nexports.colors = {\n    X: \"limegreen\",\n    Y: \"orange\",\n    Z: \"pink\",\n    boss: \"#f77\",\n};\nexports.aliensPieces = {\n    X: [new IterablePieces_1.default(aliens_1.X[0]), new IterablePieces_1.default(aliens_1.X[1])],\n    Y: [new IterablePieces_1.default(aliens_1.Y[0]), new IterablePieces_1.default(aliens_1.Y[1])],\n    Z: [new IterablePieces_1.default(aliens_1.Z[0]), new IterablePieces_1.default(aliens_1.Z[1])],\n};\nexports.bossPieces = new IterablePieces_1.default(boss_1.default);\nexports.playerPieces = new IterablePieces_1.default(player_1.default);\nexports.wigglyBulletPieces = [\n    new IterablePieces_1.default(wiggly_bullet_1.default[0]),\n    new IterablePieces_1.default(wiggly_bullet_1.default[1]),\n];\n\n\n//# sourceURL=webpack://space-invaders/./src/components/View/config.ts?");
...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.Z = exports.Y = exports.X = void 0;\nexports.X = [`\r\n....####....\r\n.##########.\r\n############\r\n###..##..###\r\n############\r\n..###..###..\r\n.##..##..##.\r\n..##....##..\r\n`, `\r\n....####....\r\n.##########.\r\n############\r\n###..##..###\r\n############\r\n...##..##...\r\n..##.##.##..\r\n##........##\r\n`];\nexports.Y = [`\r\n..#.....#..\r\n...#...#...\r\n..#######..\r\n.##.###.##.\r\n###########\r\n#.#######.#\r\n#.#.....#.#\r\n...##.##...\r\n`, `\r\n..#.....#..\r\n#..#...#..#\r\n#.#######.#\r\n###.###.###\r\n###########\r\n.#########.\r\n..#.....#..\r\n.#.......#.\r\n`];\nexports.Z = [`\r\n...##...\r\n..####..\r\n.######.\r\n##.##.##\r\n########\r\n.#.##.#.\r\n#......#\r\n.#....#.\r\n`, `\r\n...##...\r\n..####..\r\n.######.\r\n##.##.##\r\n########\r\n..#..#.\r\n.#.##.#.\r\n#.#..#.#\r\n`];\n\n\n//# sourceURL=webpack://space-invaders/./src/plans/aliens.ts?");
...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst bossPlan = `\r\n.....######.....\r\n...##########...\r\n..############..\r\n.##.##.##.##.##.\r\n################\r\n..###..##..###..\r\n...#........#...\r\n`;\nexports[\"default\"] = bossPlan;\n\n\n//# sourceURL=webpack://space-invaders/./src/plans/boss.ts?");
...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst playerPlan = `\r\n.#####............#####.\r\n.####..............####.\r\n.###.......##.......###.\r\n####.......##.......####\r\n####.......##.......####\r\n####.......##.......####\r\n####.......##.......####\r\n####......####......####\r\n###.......####.......###\r\n####......####......####\r\n.####.....####.....####.\r\n..####....####....####..\r\n.####.....####.....####.\r\n####......####......####\r\n###.......####.......###\r\n###.......####.......###\r\n####......####......####\r\n####.....######.....####\r\n###......######......###\r\n##......########......##\r\n###......######......###\r\n####.....######.....####\r\n###########..###########\r\n..########....########..\r\n`;\nexports[\"default\"] = playerPlan;\n\n\n//# sourceURL=webpack://space-invaders/./src/plans/player.ts?");
